...
import com.indianasys.boxoffice.MoviesListFragment;
...
public class MainActivity extends ActionBarActivity  implements NavigationDrawerFragment.NavigationDrawerCallbacks {
    ...
    public void onNavigationDrawerItemSelected(int position) {
       ...
       moviesListFragment =new MoviesListFragment();
        ...
        fragmentManager.beginTransaction().replace(R.id.container, moviesListFragment)
                .commit();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.action_refresh :
                FragmentManager fragmentManager = getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.container, moviesListFragment).commit();
             break;
   ...
   /* public void aboutDialog(){
        ...
        dailog.setTitle("About");
        dailog.setMessage("Get Latest Box Office Movies");
