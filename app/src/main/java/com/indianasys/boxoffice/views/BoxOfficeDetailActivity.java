...
public class BoxOfficeDetailActivity  extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load movie data
        BoxOfficeMovie movie = (BoxOfficeMovie) getIntent().getSerializableExtra(MoviesListFragment.MOVIE_DETAIL_KEY);
        loadMovie(movie);
    }
    ...
    public void loadMovie(BoxOfficeMovie movie) {
        ...
        Picasso.with(this).load(movie.getLargePosterUrl()). placeholder(R.drawable.movie_template).into(ivPosterImage);
    }
